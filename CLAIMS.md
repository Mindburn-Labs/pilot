...
- Repo name: `pilot`
- Canonical role: Separate reference system formerly described as founder-OS; user-facing product name is Pilot.
- Public/private: Reference surface; not a HELM product surface.
...
- Docs that mention each claim: Pilot docs, Mindburn `/helm` and `/company` boundaries.
- Stale claims removed: Public company footer/llms no longer promote Pilot docs as normal navigation.
- Remaining gaps: Keep rebrand remnants and docs references aligned with the Pilot name and non-normative status.
- Verification commands: Repo-local install/test/build commands.
