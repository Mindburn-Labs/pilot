...
const capabilityRecords = validateCapabilityRecords([
  ...
  },
  {
    ...
    evidence: [
      ...
      'Managed Telegram provisioning requests, claim, webhook configuration, settings updates, token rotation, disable, lead capture, and support-message intake persist redacted managed_telegram_* evidence_items linked to TELEGRAM_* audit_log rows before state mutation, external Telegram side effects, webhook acknowledgement, or reply workflow side effects',
