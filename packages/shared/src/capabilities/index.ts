...
const capabilityRecords = validateCapabilityRecords([
  ...
  },
  {
    ...
    evidence: [
      ...
      'Managed Telegram provisioning requests, settings updates, lead capture, and support-message intake persist redacted managed_telegram_* evidence_items linked to TELEGRAM_* audit_log rows before state mutation, webhook acknowledgement, or reply workflow side effects',
